...
class ExportInitiativeAssessmentsView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        headers = {
            ...
            'number_of_beneficiaries': 'How many people are estimated to benefit/will be reached by implementing the initiative?',
            'age_of_beneficiaries': 'The estimated Age groups of the beneficiaries?',
            'sex_of_beneficiaries': 'Gender of beneficiaries',
