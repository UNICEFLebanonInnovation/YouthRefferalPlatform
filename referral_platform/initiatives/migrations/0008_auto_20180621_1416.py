...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('1-6', '1-6 years'), ('7-13', '7-13 years'), ('14-24', '14-24 years'), ('25-50', '25-50 years'), ('50-plus', '50 years and above')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
            name='duration',
            field=models.CharField(blank=True, choices=[('1_2', '1-2 weeks'), ('3_4', '3-4 weeks'), ('4_6', '4-6 weeks'), ('6_plus', 'More than 6 weeks')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
            name='indirect_beneficiaries',
            field=models.CharField(blank=True, choices=[('1-50', '1-50'), ('51-100 ', '51-100'), ('501-1000', '501-1000'), ('1000-plus', 'greater than 1000')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('yes', 'Yes'), ('no', 'No'), ('somewhat', 'Somewhat')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
        ...
        migrations.AlterField(
            model_name='youthledinitiative',
            name='other_groups',
            field=models.CharField(blank=True, choices=[('ngos', 'Other NGOs'), ('schools', 'Schools'), ('municipality', 'Municipality'), ('other', 'Other')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
            name='resources_from',
            field=models.CharField(blank=True, choices=[('unicef', 'UNICEF'), ('local ', 'Local Business'), ('organization', 'Organisation')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
            name='resources_type',
            field=models.CharField(blank=True, choices=[('financial', 'Financial (self-explanatory)'), ('technical', 'Technical (for ex. developing awareness tools materials, trainings..etc)'), ('in-kind', 'In-Kind (posters, booklet,etc)')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
            name='sex_of_beneficiaries',
            field=models.CharField(blank=True, choices=[('both', 'Both male and females'), ('male', 'Only males'), ('female', 'only female')], max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='youthledinitiative',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('excellent', 'Excellent - All of our team members were committed to the initiative'), ('good', 'Good - Most of our team was committed to the initiative'), ('low', 'Low - Some team members stopped participating')], max_length=100, null=True),
        ),
    ]
