...
class ExportRegistryAssessmentsView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        data2.headers = [
            ...
            'Please check all the choice(s) that best describes your family composition',
            'Please state if any of the above household members are not living with you at the moment',
...
class ExportInitiativeAssessmentsView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        data5.headers = [
            ...
            'The estimated Age groups of the beneficiaries? (more than one option may apply)',
            ...
            'If yes, from whom?',
            'What kind of support are you planning to receive? (you can select more than one option)',
