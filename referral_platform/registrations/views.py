...
class ExportRegistryAssessmentsView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        qs = self.get_queryset().extra(select={
            ...
            'what_electronics_do_you_own': "data->>'what_electronics_do_you_own' IN ('computer')",
            'what_electronics_do_you_own': "data->>'what_electronics_do_you_own' IN ('smart_phone')",
            'what_electronics_do_you_own': "data->>'what_electronics_do_you_own' IN ('tablet')",
            'what_electronics_do_you_own': "data->>'what_electronics_do_you_own' IN ('NA')",
