...
class ExportRegistryAssessmentsView(LoginRequiredMixin, ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        headers = {
            ...
            'what_electronics_do_you_own1': 'What electronics do you own? - Laptop',
            'what_electronics_do_you_own2': 'What electronics do you own? - Computer',
            'what_electronics_do_you_own3': 'What electronics do you own? - Smart Phone',
            'what_electronics_do_you_own4': 'What electronics do you own? - Tablet',
            'what_electronics_do_you_own5': 'What electronics do you own? - NA',
        ...
        qs = self.get_queryset().extra(select={
            ...
            'what_electronics_do_you_own1': "data->>'what_electronics_do_you_own - Laptop' IN ('laptop')",
            'what_electronics_do_you_own2': "data->>'what_electronics_do_you_own - Computer' IN ('computer')",
            'what_electronics_do_you_own3': "data->>'what_electronics_do_you_own - Smart Phone' IN ('smart_phone')",
            'what_electronics_do_you_own4': "data->>'what_electronics_do_you_own - Tablet' IN ('tablet')",
            'what_electronics_do_you_own5': "data->>'what_electronics_do_you_own - NA' IN ('NA')",
            ...
            'what_electronics_do_you_own1',
            'what_electronics_do_you_own2',
            'what_electronics_do_you_own3',
            'what_electronics_do_you_own4',
            'what_electronics_do_you_own5',
