...
class ListingView(LoginRequiredMixin,
    ...
    def get_queryset(self):
        ...
        if beneficiary_flag:
            ...
            return Registration.objects.filter(governorate__parent=self.request.user.country)
        else:
...
#                 'I_can_accept_diversity_of_ideas_differences_of_opinion_from_my_classmates_friends_peers': "new_data->>'_I_can_accept_diversity_of_ideas_differences_of_opinion_from_my_classmates_friends_peers'",
#                 'When_I_have_to_make_a_decision_I_find_it_easy_to_think_of_all_the_different_options_and_alternatives_I_have_to_choose_from': "new_data->>'When_I_have_to_make_a_decision_I_find_it_easy_to_think_of_all_the_different_options_and_alternatives_I_have_to_choose_from'",
#                 'I_tend_to_question_information_that_people_tell_me_and_make_my_own_mind_up_about_things': "new_data->>'I_tend_to_question_information_that_people_tell_me_and_make_my_own_mind_up_about_things'",
#                 'Even_when_others_are_discouraged_I_keep_going_until_I_ve_found_a_way_to_fix_a_problem': "new_data->>'Even_when_others_are_discouraged_I_keep_going_until_I_ve_found_a_way_to_fix_a_problem'",
#                 'I_apply_the_lessons_I_learnt_from_my_mistakes_to_focus_on_moving_forward_with_positive_action': "new_data->>'I_apply_the_lessons_I_learnt_from_my_mistakes_to_focus_on_moving_forward_with_positive_action'",
#                 'I_feel_I_have_the_opportunties_to_be_engaged_in_my_community': "new_data->>'I_feel_I_have_the_opportunties_to_be_engaged_in_my_community'",
#                 'I_love_my_life_a_lot': "new_data->>'I_love_my_life_a_lot'",
#                 'I_am_happy_most_of_the_time':"new_data->>'I_am_happy_most_of_the_time'",
#                 'I_feel_I_fit_in_my_famlily_school_community': "new_data->>'I_feel_I_fit_in_my_famlily_school_community'",
#                 'I_have_high_expectations_for_what_I_will_achieve_in_life':"new_data->>'I_have_high_expectations_for_what_I_will_achieve_in_life'",
#                 'If_I_get_engaged_in_his_is_how_I_respond': "new_data->>'If_I_get_engaged_in_his_is_how_I_respond'",
#                 'If_your_teacher_faci_roblem_or_hesitation': "new_data->>'If_your_teacher_faci_roblem_or_hesitation'",
#                 'which_of_the_following_do_you_agree_with': "new_data->>'which_of_the_following_do_you_agree_with'",
#
#                 '_userform_id': "data->>'_userform_id'",
#                 '_submission_time': "data->>'_submission_time'",
#
