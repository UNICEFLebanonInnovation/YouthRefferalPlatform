...
This will run all tests in the [`./referral_platform/static/referral_platform/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open referral_platform/static/referral_platform/dist//reports/coverage/lcov-report/index.html
...
#### Source `./referral_platform/static/referral_platform/`
Main project source.

#### Actions `./referral_platform/static/referral_platform/actions/`
...
#### Components `./referral_platform/static/referral_platform/components/`
React components. Mostly __dumb__ components.

#### Constants `./referral_platform/static/referral_platform/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./referral_platform/static/referral_platform/containers/`
...
#### Reducers `./referral_platform/static/referral_platform/reducers/`
Reducer functions that take in the _current state_ and an _action type_ then return a new state.

#### Store `./referral_platform/static/referral_platform/store/`
...
[test-dir]: /referral_platform/static/referral_platform/__tests__/
