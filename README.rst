...
.. _`static project readme`: referral_platform/static/referral_platform/README.md
...
.. code-block:: bash
    ...
    cd referral_platform
    celery -A referral_platform.taskapp worker -l info
