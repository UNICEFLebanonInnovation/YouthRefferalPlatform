...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['leb-ems.azurewebsites.net', 'mena-ems.unicef.org','leb-container-test.azurewebsites.net', 'leb-ems-dev.azurewebsites.net'])
