...
module.exports = (opts) => {
  ...
  return {
    ...
    entry: {
      main: path.resolve(PROJECT_ROOT, 'referral_platform/static/referral_platform/index'),
      vendor: ['react', 'redux', 'react-router', 'react-redux', 'react-dom'],
    },

    output: {
      path: path.resolve(PROJECT_ROOT, 'referral_platform/static/referral_platform/bundles'),
    ...
    resolve: {
      extensions: ['', '.js', '.jsx'],
      modules: [
        path.resolve(PROJECT_ROOT, 'referral_platform/static/referral_platform'),
        'node_modules',
      ],
    },
  };
